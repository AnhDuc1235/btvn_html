...
// - Từ lần 2 trở đi: accumulator sẽ là return của lần trước (mỗi lần callback
//   return --> lưu vào accumulator)
...
// // }
// // console.log(total);  // đây là cách tính tổng thông thường

// const total = numbers.reduce(function(acc, cur) {
//     return acc + cur; // cứ return là giá trị sẽ được lưu lại vào biến acc
// }, 0);
// console.log(total);
...
// //output là 1 mảng thì giá trị khởi tạo cũng phải là 1 mảng

// const newArr = myArr.reduce(function (acc, cur) {
//     if (!acc.includes(cur)) {  //nếu acc không chứa cur thì push cur vào acc
//         acc.push(cur);
//     }
//     return acc;
// }, []);
...
// //     }
// // }
// // console.log(max)  // Cách làm thông thường
...
//     //     return acc;
//     // }
//     return acc < cur ? cur : acc; // có thể làm bằng toán tử 3 ngôi
// }); // nếu không có giá trị khởi tạo: lấy phần tử đầu tiên làm acc
// console.log(max);
