...
// Muốn truy cập vào non static: chuyển sang instance:
...
// const boy = new Boy("Hoàng An", "hoangan.web@gmail.com", 33);
...
//     // Không phải mảng
//     // khác null
//     return typeof obj === "object" && !Array.isArray
//     (obj) && obj !== null;
// }
...
//             const subObj = obj1[key];

//             // Kiểm tra length
//             const subLength1 = Object.keys(obj1[key]).length;
//             const subLength2 = Object.keys(obj1[key]).length;
...
// Sử dụng đệ quy để so sánh thằng object meta:
// const isObject = (obj) => {
//     // typeof = object
//     // Không phải mảng
//     // khác null
...
// // const b = {...a}; //Spread (giả từng key của object a) (cũng 1 cấp)
...
// // const b = a;
// // Shallow copy:
// // - Dùng các phương thức xử lý mảng có trả về mảng mới: slice, map, filter, reduce
// // - Dùng spread
// // const b = a.slice(0);
// // const b = [...a];
...
// Destructuring: Phá vỡ cấu trúc của object, array để truy cập vào các phần tử của nó. Sau đó lưu trữ thành các biến riêng biệt
// const user = {
//     name: "Hoàng An",
//     email: "hoangan.web@gmail.com",
//     age: 33,
...
// Buổi sau: DOM = Document Object Model